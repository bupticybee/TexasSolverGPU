...
[English](./README.md) | [简体中文](./README.zh-CN.md) | [日本語](./README.ja-JP.md) | README 한국어 | [Español](./README.es-ES.md)

<p align="center">
  <img src="./assets/images/logo-solid.png" alt="TexasSolver GPU logo" width="220" />
</p>

TexasSolver GPU는 GPU 가속 텍사스 홀덤 솔버의 Windows 공개 배포 저장소입니다.

## 소개

TexasSolver GPU는 NVIDIA GPU가 있는 Windows 환경에서 로컬 분석을 수행하기 위해 만들어졌습니다. 데스크톱 앱에는 네이티브 solver runtime과 GUI가 함께 포함되어 있어 다음과 같은 작업을 할 수 있습니다.
