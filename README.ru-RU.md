...
TexasSolver GPU - это публичный репозиторий дистрибуции Windows-версии GPU-ускоренного солвера для Texas Hold'em.

## О проекте

TexasSolver GPU предназначен для локального анализа в Windows на машинах с NVIDIA GPU. Настольное приложение объединяет нативные solver runtime и GUI, чтобы вы могли:
